...
/**
 * A custom secondary button for Foliary, styled according to the app's design system.
 *
...
/**
 * Button preview for FoliarySecondaryButton.
 */
@Preview
@Composable
private fun FoliarySecondaryButtonPreview() {
    FoliaryTheme {
